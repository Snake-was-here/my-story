...
**Agent ecosystem reference:** See Agent Ecosystem table in SOUL.md
...
## Coding Standards (Integrated from CLAUDE.md)

**1. Think Before Coding:**
- Don't assume. Don't hide confusion. Surface tradeoffs.
- If something is unclear, stop. Name what's confusing. Ask the main agent.
...
- Remove orphans created by YOUR changes only.

**4. Goal-Driven Execution:**
- Define success criteria upfront.
- For "Add validation" → "Write tests for invalid inputs, then make them pass."
- For multi-step tasks, state: Step → Verify check.
